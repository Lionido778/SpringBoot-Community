...
public class DigestHelper {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        System.out.println(digest("community", "MD5"));
        System.out.println(digest("community", "SHA"));
        System.out.println(digest("community", "SHA1"));
        System.out.println(digest("community", "SHA-256"));
        System.out.println(digest("community", "SHA-384"));
        System.out.println(digest("community", "SHA-512"));
